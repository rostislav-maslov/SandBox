...
<div class="row" style="margin-top: 10px">
    <div class="col-lg-12">
        <table class="table table-bordered" id="table-1">
            <thead>
            <tr>
                <th>Имя</th><th>Фамилия</th><th>User ID</th><th>Номер Телефона</th>
                <th>Дата создания</th>
            </tr>
            </thead>
            <tbody>
            ...
            <c:forEach items="${search.result}" var="doc">
                ...
                <tr class="curcor-pointer modal-courier-line" data-id="${doc.id}" data-title="${doc.title}">
                    <td>${doc.firstName}</td><td>${doc.lastName}</td><td>${doc.userId}</td><td>${doc.phoneNumber}</td>
...
<div class="row">
    <div class="col-lg-12 text-center">
        <ul class="pagination pagination-sm">
            ...
            <li>
                <a href="#" class="modal-courier-goto" data-query="${search.query}"
