...
<div class="row" style="margin-top: 10px">
    <div class="col-lg-12">
        <table class="table table-bordered" id="table-1">
            <thead>
            <tr>
                <th>Заголовок</th><th>Описание</th><th>Картинка</th><th>Активный ресторан</th><th>Координаты</th>
                <th>Дата создания</th>
            </tr>
            </thead>
            <tbody>
            ...
            <c:forEach items="${search.result}" var="doc">
                ...
                <tr class="curcor-pointer modal-restaurant-line" data-id="${doc.id}" data-title="${doc.title}">
                    <td>${doc.title}</td><td>${doc.description}</td><td>${doc.picId}</td><td>${doc.available}</td><td>${doc.point}</td>
...
<div class="row">
    <div class="col-lg-12 text-center">
        <ul class="pagination pagination-sm">
            ...
            <li>
                <a href="#" class="modal-restaurant-goto" data-query="${search.query}"
