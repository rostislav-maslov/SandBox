...
<div class="row">
    <form action="<%= RestaurantAdminRoutes.ALL%>" method="GET">
        <div class="col-lg-5">
            ...
            <table class="table table-bordered" id="table-1">
                ...
                <c:forEach items="${search.result}" var="doc">
                    <tr>
                        ...
                        <td>
                            <c:url value="<%= RestaurantAdminRoutes.EDIT%>" var="editUrl">
                            ...
                            <c:url value="<%= RestaurantAdminRoutes.DELETE%>" var="urlDelete">
                                <c:param name="id" value="${doc.id}"/>
                            </c:url>
...
<div class="row">
    <div class="col-lg-12 text-center">
        <ul class="pagination pagination-sm">
            <c:url value="<%= RestaurantAdminRoutes.ALL%>" var="urlPrev">
            ...
            <c:forEach items="${search.paginator()}" var="page">
                <c:url value="<%= RestaurantAdminRoutes.ALL%>" var="urlPage">
                    <c:param name="query" value="${search.query}"/>
            ...
            <c:url value="<%= RestaurantAdminRoutes.ALL%>" var="urlNext">
                <c:param name="query" value="${search.query}"/>
